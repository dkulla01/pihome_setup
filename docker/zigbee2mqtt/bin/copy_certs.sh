...
zigbee2mqtt_mqtt_client_certs_dir="$certs_root_dir/zigbee2mqtt-mqtt-client"
zigbee2mqtt_mqtt_client_key="$zigbee2mqtt_mqtt_client_certs_dir/client.key"
zigbee2mqtt_mqtt_client_cert="$zigbee2mqtt_mqtt_client_certs_dir/client.crt"

ensure_file_exists "$mosquitto_server_key"
ensure_file_exists "$mosquitto_server_cert"
ensure_file_exists "$zigbee2mqtt_mqtt_client_key"
ensure_file_exists "$zigbee2mqtt_mqtt_client_cert"
...
zigbee2mqtt_mqtt_client_cert_destination_dir="$zigbee2mqtt_root_dir/zigbee2mqtt-ssl"
mkdir -p "$zigbee2mqtt_mqtt_client_cert_destination_dir"
cp "$zigbee2mqtt_mqtt_client_key" "$zigbee2mqtt_mqtt_client_cert_destination_dir"
cp "$zigbee2mqtt_mqtt_client_cert" "$zigbee2mqtt_mqtt_client_cert_destination_dir"
cp "$pihome_ca_cert" "$zigbee2mqtt_mqtt_client_cert_destination_dir"
