...
mosquitto_client_certs_destination_dir="$zigbee2mqtt_root_dir/zigbee2mqtt-ssl"
mkdir -p "$mosquitto_client_certs_destination_dir"
cp "$mosquitto_client_key" "$mosquitto_client_certs_destination_dir"
cp "$mosquitto_client_cert" "$mosquitto_client_certs_destination_dir"
