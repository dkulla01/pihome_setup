...
build_certs "$mosquitto_client_cert_creation_dir" 'mqtt-explorer-client' 'pihome-mqtt-client.run' "$mosquitto_sans_domains_file" "$pihome_ca_pemfile" "$pihome_ca_key" "$ca_key_password"
build_certs "$mosquitto_client_cert_creation_dir" 'homeassistant-client' 'pihome-mqtt-client.run' "$mosquitto_sans_domains_file" "$pihome_ca_pemfile" "$pihome_ca_key" "$ca_key_password"
