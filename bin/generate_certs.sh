...
build_certs "$nginx_cert_creation_dir" 'pihome.run' "$nginx_cert_sans" "${pihome_ca_pemfile}" "${pihome_ca_key}"

mosquitto_cert_sans="$(build_dns_sans_block 'pihome.run')"
mosquitto_server_cert_creation_dir="${cert_creation_dir}/mosquitto-server"
build_certs "$mosquitto_server_cert_creation_dir" 'server' "$mosquitto_cert_sans" "${pihome_ca_pemfile}" "${pihome_ca_key}"

mosquitto_client_cert_creation_dir="${cert_creation_dir}/mosquitto-client"
build_certs "$mosquitto_client_cert_creation_dir" 'client' "$mosquitto_cert_sans" "${pihome_ca_pemfile}" "${pihome_ca_key}"
