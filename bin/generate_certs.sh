...
traefik_cert_sans="$(build_dns_sans_block 'pihome.run' 'traefik.pihome.run' 'pihole.pihome.run' 'homebridge.pihome.run' 'zigbee2mqtt.pihome.run')"
build_certs "$traefik_cert_creation_dir" 'pihome.run' 'pihome.run' "$traefik_cert_sans" "${pihome_ca_pemfile}" "${pihome_ca_key}"
